        ...
        <div class="space-between row">
            <div class="cartegory-left">
                <ul style="position:fixed">
                    ...
                    <a style="text-decoration:none" href="#"><li style="background-color:#adabab" class="cartegory-left-li">QUẢN LÝ KHÁCH HÀNG
                    </li></a> 
                </ul>
            </div>
            <div class="cartegory-right row">                
                <div class="card">
                    ...
                    <div class="card-body">    
                        <a class="btn btn-primary" style="margin-bottom:20px;" href="indexkh.php?page_layout=them">Thêm Mới</a>
                        <form style="padding-bottom:10px"  action="?actions=search" method="POST">
                            <fieldset style="border:1px solid #ccc;padding-bottom:10px">
                                <legend>Tìm kiếm khách:</legend>
                                Mã KH: <input type="text" name="id" value="<?=!empty($id)?$id:""?>" />
                                <input class="btn btn-primary" type="submit" value="search">
                            </fieldset>
                        </form>               
                        <p>Tổng số khách hàng: <?=$totalRecords?> </p>
                        <table class="table">
                        ...
                        <tbody class="tbody-dark">                        
                            <?php
                                while ($row = mysqli_fetch_array($oder)) {  
                            ?>
                            <tr>
                                <td><p ><?=$row['id']?></p></td>                             
                                <td><p><?=$row['name']?></p></td>                                
                                ...
                                <td><p >$<?=number_format($row['total'],0,",",",")?></p></td>
                                <td><p ><?=date("d/m/Y H:i", $row['created_time'])?></p></td>
                                <td>
                                    <p ><a class="btn-edit" style=" text-decoration: none;" href="indexkh.php?page_layout=sua&id=<?php echo $row['id']; ?>">sửa</a></p>
                                </td>
                                <td>
                                    <p ><a class="btn-edit" style=" text-decoration: none;" onClick="return Del('<?php echo $row['id']; ?>')" href="indexkh.php?page_layout=xoa&id=<?php echo $row['id']; ?>">xóa</a></p>
                                </td>							
                            </tr>
                            <?php } ?>            
                        </tbody>
                    ...
                    <div class="cartegory-right-bottom row">
                        <div class="cartegory-right-bottom-items">                        
                            <p>Hiển thị <?=$item_per_page?><span>|</span><?=$totalRecords?> khách hàng</p>
                        </div>
                        <div class="cartegory-right-bottom-items">
